<?php 
    ...
    $enters = tampil("SELECT * FROM transaksi a, foto b where a.id=b.id ORDER BY b.id DESC");
                        ...
                        <table class="table table-striped table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
									...
									<td><?= '<img class="img" width ="70px" src="data:image/jpeg;base64,'.base64_encode( $enter['foto'] ).'"/>' ?></td>
                                    <td><?= $enter["berat"] ?></td>
