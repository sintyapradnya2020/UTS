        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#menu-toggle" id="menu-toggle">Laundry Sintya</a>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="homepage">
                                <div class="text-center">
                                    <h2>Welcome to Laundry Sintya</h2>
                                    <p>
                                        Halo <b><?php echo $username;?></b>, Selamat datang di Laundry Sintya :]
                                        <br /> Pendataan dari laundry yang masuk dan keluar
                                    </p>
                                </div>
                            </div>
                        </div>
