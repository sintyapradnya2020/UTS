...
<html lang="en">
    <head>
        ...
        <title>Login | Laundry Sintya</title>
    ...
    <body class="text-center">
        <form class="form-signin" action="" method="post">
            ...
            <h1 class="h3 mb-3 font-weight-normal">Laundry Sintya</h1>
            ...
            <?php endif; ?>
            <p class="mt-5 mb-3 text-muted">&copy; 2020 Putu Sintya Pradnya Paramitha (1915051102) </p>
        </form>
    </body>
</html>
